...
R2(dhcp-config)#ip dhcp excluded-address 192.168.1.1 192.168.1.10
...
R2(dhcp-config)#ip dhcp excluded-address 203.0.113.1
...
R2(dhcp-config)#do show ip dhcp binding
