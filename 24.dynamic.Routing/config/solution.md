...
2. Configure floating static routes (**static route with higher Administrative Distance**) on R1 and R2 that allow PC1 to reach SRV1 if the link between R1 and R2 fails. Do the routes enter the routing tables of R1 and R2?
